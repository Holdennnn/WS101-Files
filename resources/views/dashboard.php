...
<body>
 <div class="main-container">
  <div>
   <div class="name"><h1 class="name-b" id=>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HC Bank</h1>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/logo2.png" width="40%" height="125px"/></div>
   <div class="main">
    
    
    <div class="pas" id="pas" style="display:block">
    <div><h1 class="heading head1" id="pinHeading"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin Code</h1></div>
    <div id="pinDiv" style="display:;">
    <input type="password" id="pin1" placeholder="4 digits" class="pin" maxlength="4"/>
    <button class="btnOK" id="btnEnter">Enter</button>
    </div>
    <div class="trans"><h3 id="pinMsg" class="heading head1" style="color:#fff"></h3></div>
    </div>
    ...
    <div class="buttons-left">
      <button class="btn" id="withdarawal"><h1 class="btn-text"></h1>Cash Withdrawal</button>
      <button class="btn" id="billPay"><h1 class="btn-text"></h1>Bill Payment</button>
      <button class="btn" id="ballanceInquiry"><h1 class="btn-text"></h1>Ballance Inquiry</button>
      
     </div>
     <div class="buttons-right">
      <button class="btn" id="transfer"><h1 class="btn-text"></h1>Transfer</button>
      <button class="btn" id="deposit"><h1 class="btn-text"></h1>Deposit</button>
      <button class="btn" id="Exit"><h1 class="btn-text"></h1>Exit</button>
 ...
 let amounts=document.getElementById('amounts');
  ...
  pinHeading.innerHTML="";
  pinMsg.innerHTML="Have a nice day!";
